...
Overall, visual similarity has been prioritized throughout the optimization process, and any speedups unpreserving of the general look and feel of default plotting haven't been utilized. Below are examples of the different optimization tiers described above, paired with a table of draw times. 
